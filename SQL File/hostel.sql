...
CREATE TABLE `honeypot_logs` (
  ...
  `attempted_password` VARCHAR(255) DEFAULT NULL,
...
-- 
INSERT INTO `honeypot_logs` (`id`, `attempted_email`, `attempted_password`, `ip_address`, `user_agent`, `country`, `city`, `attempted_at`) VALUES ;
