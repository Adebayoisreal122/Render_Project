                                    ...
                                    <div class="col-md-4">
                                        <div class="panel panel-default">
                                            <div class="panel-body bk-danger text-light">
                                                <div class="stat-panel text-center">
                                                    <?php
                                                    $result3 ="SELECT count(*) FROM honeypot_logs";
                                                    ...
                                                    <div class="stat-panel-title text-uppercase">Honeypot Login Attempts
                                                    </div>
                                                </div>
                                            </div>
                                            <a href="honeypot_logs.php"
                                                class="block-anchor panel-footer text-center">View Logs &nbsp; <i
                                                    class="fa fa-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
